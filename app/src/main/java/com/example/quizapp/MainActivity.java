...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    void loadNewQuestion() {
        ...
        questionsTextView.setText(com.example.quizapp.QuestionAnswer.question[currentQuestionIndex]);
        ans_a.setText(com.example.quizapp.QuestionAnswer.choices[currentQuestionIndex][0]);
        ans_b.setText(com.example.quizapp.QuestionAnswer.choices[currentQuestionIndex][1]);
        ans_c.setText(com.example.quizapp.QuestionAnswer.choices[currentQuestionIndex][2]);
        ans_d.setText(com.example.quizapp.QuestionAnswer.choices[currentQuestionIndex][3]);
    }
    void finishQuiz() {
        String passStatus ="";
